...
export declare class Config {
	private config;
	private require;
	load(configPath: string | undefined): Promise<Config>;
	private loadConfig;
	private applyConfig;
	get<K extends keyof Veve>(key: K): Veve[K];
}
export declare function isValidConfig(veve: any): boolean;
 ...
 * trackedAdd(1, 2); // 3
 */
export declare function Fn<T extends any[], R>(
 ...
 */
export declare function spy<T extends any[], R>(
	obj: {
		[key: string]: (...args: T) => R;
	},
	method: string,
