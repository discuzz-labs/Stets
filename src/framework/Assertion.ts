...
class Assertion {
  ...
  /**
   * Internal method to assert a condition and handle throwing or returning based on configuration.
   * @param {boolean} condition - The condition to evaluate.
   * @param {string} message - Error message to use if assertion fails.
   * @param {string} matcher - Name of the matcher for error context.
   * @returns {Assertion | boolean} Assertion instance or boolean based on configuration.
   */
  private assert(
    condition: boolean,
    message: string,
